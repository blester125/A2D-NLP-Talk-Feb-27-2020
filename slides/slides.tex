    ...
    \begin{frame}
        ...
        \note{
            \begin{itemize}
                ...
                \item The speaker notes also have links to where I got the images and a few extra blog posts that can supplement
...
\begin{section}{Motivation}
    \begin{subsection}{What is batching?}
        ...
        \note{
            \begin{itemize}
                \item First I'm going to build up to batching by doing more and more work in a single function call. We
                    start with Binary LR
                ...
                \item Normally we then use a function like sigmoid to create a final probability (and then calculate
...
\begin{frame}[fragile]
    ...
    \note{
        \begin{itemize}
            ...
            \item We can use the dot product function to calculate the sum of the elementwise product of the
                vectors.
        \end{itemize}
    }
\end{frame}
        ...
        \begin{frame}
            ...
            \note{
                \begin{itemize}
                    ...
                    \begin{itemize}
                        \item In binary LR we are deciding between two things, for example Positive or Negative sentiment
            ...
            \note{
                \begin{itemize}
                    ...
                    \item This works because the rows and columns in matrix-matrix multiplication all act independently
                        of each other.
                    \item This means we can put totally unrelated data an be next to each other and they won't interact as it flows through
                        your network
...
\begin{section}{Batching is hard in NLP}
    ...
    \begin{frame}
        ...
        \note{
            \begin{itemize}
                ...
                \item We are going to use a new symbol called \textless PAD\textgreater .
    ...
    \begin{frame}
        ...
        \note{
            \begin{itemize}
                \item Now that some of our examples are longer because of this \textless PAD\textgreater we need to track how long the
                    actual data is
        ...
        \begin{frame}
            ...
            \note{
                \begin{itemize}
                    ...
                    \item We do a mean over time for each feature, this means feature is mean-ed separately by looking
                        at it's value for each individual word.
...
\end{frame}
    ...
    \begin{subsection}{Token Level Losses}
        \begin{frame}
            ...
            \note{
                \begin{itemize}
                    ...
                    \item $y$ is the vector that has our real labels and $\hat{y}$ is our predicted labels
                    ...
                    \item In classification where we output a probability distribution over classes we can use this loss
        ...
        \begin{frame}<1>
            ...
            \note{
                \begin{itemize}
                    \item This idea of sparse cross entropy can be extended to the idea of a token level loss.
        ...
        \begin{frame}
            ...
            \note{
                \begin{itemize}
                    ...
                    \item Toolkits like tensorflow will probably make you do this yourself.
                \end{itemize}
            }
        \end{frame}
  ...
  >>> array([[0.50917835, 0.3772086 , 0.11361305]])
    ...
    \note{
        \begin{itemize}
            ...
            \item We we can also see that the values calculated for the shorter example are very different than when that
        ...
        \begin{frame}
            ...
            \note{
                \begin{itemize}
                    ...
                    \item In our token level loss from before we made a decision about the label of a token without
                        considering the label we chose for the last token.
            ...
            \note{
                \begin{itemize}
                    \item A way to look at these two algorithms is that they are the same algorithm using different
                        semirings. A semirings is basically a re-definition of math in some contenxt that uses different
                        operations for sums and additions
                        \begin{itemize}
        ...
        \begin{frame}
            ...
            \note{
                \begin{itemize}
                    ...
                    \item Another advantage of this conv-padding is that without padding there is only a single
